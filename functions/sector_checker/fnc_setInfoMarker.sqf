...
_arg_markerInfo setMarkerText format ["Sector %1, %2 (lvl %3, def %4, att %5, Cd %6)", _arg_markerText, _arg_ownerSide, _arg_level, _arg_paramDefenders, _arg_paramAttckers,_arg_countdown];
