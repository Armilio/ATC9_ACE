class AllowedCachesGear
{
		class CommonB
		{
			...
			allowedAmmo[] = {"HandGrenade","SmokeShellBlue","SmokeShellGreen","SmokeShellOrange","SmokeShellPurple","SmokeShellRed","SmokeShell","SmokeShellYellow","O_IR_Grenade","Chemlight_blue","Chemlight_green","Chemlight_red","Chemlight_yellow"};
			
			allowedItems[] = {
				              "H_HelmetSpecB", "H_Booniehat_oli", //Headgear
							  "Uniform_ATACS", //Uniform
							  "V_TacVest_oli", "V_TacChestrig_oli_F", //Vest
							  "ACE_Flashlight_MX991","ACE_MapTools","ACE_wirecutter","ACE_EarPlugs","ACE_Flashlight","ACE_IR_Strobe_Item","ItemMap","ItemCompass","ItemWatch","tf_anprc152","FirstAidKit","ACE_NVG_Gen4","Binocular"
							  };
			...
			canTake[] = {"B_Mortar_01_support","B_Mortar_01_weapon","B_HMG_01_high_weapon_F","B_HMG_01_support_F","B_HMG_01_support_high_F","O_Mortar_01_support","O_Mortar_01_weapon","O_HMG_01_high_weapon_F","O_HMG_01_support_F","O_HMG_01_support_high_F", "Titan_AA","Titan_AT","Titan_AP","ATC_MAG_Titan_AA","ATC_TITAN_AA_starter", "MRAWS_HEAT_F", "MRAWS_HE_F", "Vorona_HE", "Vorona_HEAT", "ACE_1Rnd_82mm_Mo_HE", "ACE_1Rnd_82mm_Mo_Smoke", "ACE_1Rnd_82mm_Mo_Illum","ACE_1Rnd_82mm_Mo_HE_LaserGuided", "ATC_ClaymoreDirectionalMine_Remote_Mag","ATC_SatchelCharge_Remote_Mag","ATC_DemoCharge_Remote_Mag","ATC_ATMine_Range_Mag","ATC_APERSBoundingMine_Range_Mag","ATC_APERSTripMine_Wire_Mag","ATC_APERSMine_Range_Mag","ATC_ClaymoreDirectionalMine_Remote_Mag", "ATC_SLAMDirectionalMine_Wire_Mag", "ACE_Clacker"};
		};
		...
		class AutoriflemanB3
		{
			...
			pointers[] = {"RH_TD_ACB_b","RH_TD_ACB","bipod_01_F_blk"};
		};
		...
		class AutoriflemanR3
		{
			...
			pointers[] = {"RH_TD_ACB_b","RH_TD_ACB", "bipod_02_F_tan"};
		};
		...
		class SpecExpB3
		{
			...
			allowedAmmo[] = {"ClaymoreDirectionalMine_Remote_Mag","DemoCharge_Remote_Mag","ATMine_Range_Mag","APERSMine_Range_Mag","APERSTripMine_Wire_Mag","ClaymoreDirectionalMine_Remote_Mag","SatchelCharge_Remote_Mag","SLAMDirectionalMine_Wire_Mag"};
		    	allowedItems[] = {"ACE_Clacker", "ACE_M26_Clacker","ACE_DefusalKit"};
